...
- [x] Phase 2 — Install `@scalar/express-api-reference` in `services/gateway`
- [x] Phase 3 — Write `services/gateway/openapi.yaml` covering all endpoints:
...
- [x] Phase 4 — Mount Scalar and spec route in `services/gateway/src/app.ts`
- [x] Phase 5 — Preflight, commit, push, raise PR
